            ...
            <div class="auth-wrapper auth-v2">
                <div class="auth-inner row m-0">
                    ...
                    <a class="brand-logo" href="javascript:void(0);">
                        ...
                        <h2 class="brand-text text-primary ml-1">Finans</h2>
                    </a>
                    <!-- /Brand logo-->
                    <!-- Left Text-->
                    ...
                    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            <h2 class="card-title font-weight-bold mb-1">Hoşgeldin kral👋</h2>
                            <p class="card-text mb-2">Giriş yapmak için lütfen aşağıdaki bilgileri gir.</p>
                            <form class="auth-login-form mt-2" action="{{ route('login.custom') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="d-flex justify-content-between">
                                        <label for="login-password">Şifre</label>{{--<a href="page-auth-forgot-password-v2.html"><small>Forgot Password?</small></a>--}}
                                    </div>
                                ...
                                <button class="btn btn-primary btn-block" tabindex="4">Giriş Yap</button>
                            </form>
