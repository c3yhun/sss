            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Yatırımlar</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Anasayfa</a></li>
                                    <li class="breadcrumb-item"><a href="{{ route('admin.investments.index') }}">Yatırımlar</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <table class="datatables-basic table">
                                    ...
                                    <tbody>
                                    @foreach($investment as $key => $row)

                                        @php($query = \App\Models\Deposit::where('id',$row->deposit_id)->first())

                                        <tr>
                                            <td>{{ ++$key }}</td>
                                            <td>{{ $row->description }}</td>
                                            <td>{{ $row->amount }}</td>
                                            <td>%{{ (isset($query->income_commission)) ? $query->income_commission:'' }}</td>
                                            <td>{{ (isset($query->title)) ? $query->title:'' }}</td>
