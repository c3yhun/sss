...
@section('title', 'Toplu Ödeme Yükle (Excel)')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Ödeme (Excel)</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Anasayfa</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('admin.payments.index') }}">Ödemeler</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Ödeme (Excel)</h4>
                                </div>
                                <div class="card-body">

                                    <form action="{{ route('admin.payment.import') }}" class="form" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
