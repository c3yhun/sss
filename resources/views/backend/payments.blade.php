            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Manuel İşlemler</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Anasayfa</a></li>
                                    <li class="breadcrumb-item"><a href="{{ route('admin.payments.index') }}">Manuel İşlemler</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="datatables-basic table">
                                    ...
                                    @foreach($payment as $key => $row)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('admin.payments.destroy',$row->id) }}" method="POST">
