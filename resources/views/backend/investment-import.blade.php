...
@section('title', 'Toplu Yatırım Yükle (Excel)')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Yatırım (Excel)</h2>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Yatırım (Excel)</h4>
                                </div>
                                <div class="card-body">

                                    <form action="{{ route('admin.investment.import') }}" class="form" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
