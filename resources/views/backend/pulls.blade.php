            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Çekimler</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Anasayfa</a></li>
                                    <li class="breadcrumb-item"><a href="{{ route('admin.pulls.index') }}">Çekimler</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="datatables-basic table">
                                    ...
                                    @foreach($pull as $key => $row)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $row->amount }}</td>
                                            <td>%{{ (isset($query->expense_commission)) ? $query->expense_commission:'' }}</td>
