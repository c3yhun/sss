            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Yatırım Düzenle</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Anasayfa</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('admin.investments.index') }}">Yatırımlar</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">({{ $investment->description }}) Düzenle</h4>
                                </div>
                                <div class="card-body">

                                    <form action="{{ route('admin.investments.update',$investment->id) }}" class="form" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="description" class="form-control" value="{{ $investment->description }}" name="description" placeholder="Açıklama girin.">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="fp-default" value="{{ $investment->date }}" name="date" class="form-control flatpickr-basic" placeholder="YYYY-MM-DD"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="amount" class="form-control" value="{{ $investment->amount }}" name="amount" placeholder="Miktar girin.">
                                                </div>
                                            </div>
                                                    ...
                                                    <select class="form-control" id="deposit_id" name="deposit_id">
                                                        @if(\App\Models\Deposit::count() > 0)
                                                            @foreach(\App\Models\Deposit::all() as $item)
                                                                <option {{ $investment->deposit_id == $item->id ? "selected" : "" }} value="{{$item->id}}">{{$item->title}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
