            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Gruplar</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Anasayfa</a></li>
                                    <li class="breadcrumb-item"><a href="{{ route('admin.groups.index') }}">Gruplar</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="datatables-basic table">
                                    ...
                                    @foreach($group as $key => $row)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="badge badge-{{ $row->color }}">
                                                    <i data-feather="star" class="mr-25"></i>
                                                    <span>{{ \Illuminate\Support\Str::ucfirst($row->color) }}</span>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="badge badge-primary">{{ \App\Models\Deposit::where('group_id',$row->id)->count() }}</div>
